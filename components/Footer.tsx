    ...
    <footer className="border-t border-gray-200 py-12 text-center bg-gradient-to-r from-gray-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="flex justify-center gap-6 mb-8">
          ...
          <a href="https://www.linkedin.com/in/nikhil00111/" className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 text-white flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
